...
/** A wrapper around the stuff in DecimalMagicNumbers. */
class DecimalMagicNumbers {
 public:
  ...
  static std::unordered_map<uint128_t, class MagicNumber128, Unsigned128BitHash> magic_map128_bit_constant_division;

  /** Magic numbers for 256-bit division with specific constants. */
  static std::unordered_map<uint128_t, class MagicNumber256, Unsigned128BitHash> magic_map256_bit_constant_division;

  /** Powers of two, used during constant division of a decimal with a power of two. */
  static std::unordered_map<uint128_t, uint32_t, Unsigned128BitHash> power_two;
};